...
/**
 * Classe CelluleRendererTableMarees, permet de rendre plus agréable à regarder la table contenant les marées.
...
public class CelluleRendererTableMarees extends JLabel implements TableCellRenderer,ConstantesInterface {
	...
	/**
	 * Cette méthode est utilisée par le PanelTableMarees dans le but de changer le style du tableau.
